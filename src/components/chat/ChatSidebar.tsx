  ...
  return (
    <aside className="hidden md:block w-64 overflow-y-auto px-0">
      <div className="space-y-0">
        {/* Profile and Menu */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-x border-t border-b-0 p-4 rounded-none">
        ...
        {/* Shortcuts */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-x border-b-0 p-4 rounded-none">
        ...
        {/* Topics */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-x border-b p-4 rounded-none">
