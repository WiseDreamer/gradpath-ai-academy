...
const ChatSidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden md:block w-64 overflow-y-auto p-0 m-0">
      <div className="space-y-0">
        {/* Profile and Menu */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-t border-b-0 border-x-0 p-4 rounded-0">
        ...
        {/* Shortcuts */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-b-0 border-x-0 p-4 rounded-0">
        ...
        {/* Topics */}
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-b border-x-0 p-4 rounded-0">
